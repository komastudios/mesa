...
impl ZCull {
    ...
    pub fn new(
        ...
        let format_priorities = [
            (SetZcullSubregionAllocationFormat::Z_4x8_2x2, 8),
            (SetZcullSubregionAllocationFormat::Z_8x8_4x2, 4),
            (SetZcullSubregionAllocationFormat::Z_16x16_4x2, 2),
            (SetZcullSubregionAllocationFormat::Z_16x16x2_4x4, 1),
        ];
        ...
        let region_format = SetZcullRegionFormatType::Z_4x4;
        ...
        assert!(aliquot_count <= dev_info.aliquot_total.into());
        ...
        ZCull {
            ...
            aliquot_count: aliquot_count.try_into().unwrap(),
            subregions,
